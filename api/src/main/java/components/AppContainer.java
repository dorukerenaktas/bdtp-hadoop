...
public class AppContainer extends JFrame {
    ...
    private final JTextField txtB = new JTextField("/inputs/stocks");
    ...
    private void btnStartClick() {
        switch (selector.getSelectedIndex()) {
            case 0:
                DockerCommand.RunMapReduce("CloseStdMapReduce", txtB.getText(), txtC.getText());
                break;
            case 1:
                DockerCommand.RunMapReduce("MaxPriceDifferenceMapReduce", txtB.getText(), txtC.getText());
                break;
            case 2:
                DockerCommand.RunMapReduce("MinOpenCloseDifferenceMapReduce", txtB.getText(), txtC.getText());
                break;
            case 3:
                DockerCommand.RunMapReduce("MinOpenPriceMapReduce", txtB.getText(), txtC.getText());
                break;
            case 4:
                DockerCommand.RunMapReduce("VolumeAvgMapReduce", txtB.getText(), txtC.getText());
                break;
        }
